...
<div class="site-body uk-container uk-container-center">
	<div class="uk-grid uk-grid-divider uk-grid-preserve" data-uk-grid-match>
		<div class="site-block home-col-1 uk-width-medium-3-4">
			
			<h2 class="block-title">LATEST TUTORIALS</h2>
			

			<article class="article-item">
				<h1 class="article-title">
					<a href="#">Proin gravida nibh vel velit auctor aliquet</a>
				</h1>

				<div class="article-thumb">
					<img src="//placehold.it/574x190" width="100%">
				</div>
		...
		<div class="home-col-1 uk-width-medium-1-4">
